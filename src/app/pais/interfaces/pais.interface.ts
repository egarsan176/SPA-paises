...
//hago una peticion get en thunderClient a https://restcountries.com/v3.1/name/peru
//la salida la paso a https://app.quicktype.io/ y aquí genero la interfaz en typeScript
...
export class Convert {
    public static toPais(json: string): Pais[] {
        return cast(JSON.parse(json), a(r("Pais")));
    }

    public static paisToJson(value: Pais[]): string {
        return JSON.stringify(uncast(value, a(r("Pais"))), null, 2);
    }
}
